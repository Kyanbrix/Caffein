...
public class ItunesSearchResponse {
    ...
    public List<TrackResult> getResults() { return results; }
    public void setResults(List<TrackResult> results) { this.results = results; }
    ...
    public static class TrackResult {
        ...
        public void setCollectionArtistName(String collectionArtistName) { this.collectionArtistName = collectionArtistName; }
        ...
        public void setDiscCount(int discCount) { this.discCount = discCount; }
        ...
        public void setStreamable(boolean streamable) { isStreamable = streamable; }

        // --- Utility Helpers ---
        public String get600x600ArtworkUrl() {
